...
Material for advanced git use. This repository holds the source code of the webpage that is rendered [here](https://hsf-training.github.io/hsf-training-advanced-git-webpage/). Contributions are welcome (see below)!
